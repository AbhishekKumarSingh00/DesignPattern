...
public class RateLimit {
    ...
    // used taki same time pr same userID ka value pick ho toh handle ho jaye
    // use of LinkedList because in future we will remove elements using ith index not iterator that's why
    //use ArrayList mai dikkat hota
